...
void lv_example_tabview_2(void)
{
    ...
    lv_obj_set_pos(img, 40, 80);  // 直接设置绝对坐标（覆盖居中对齐）  
		toesp(tab2);
		lv_obj_t *temp_bar =create_temperature_bar(tab3, -20, 40, 25, 40, 25);
		update_temperature(temp_bar, Dht11Type.setTemp);
		...
		create_humidity_arc(tab4, 20,90, 30);
...
{ 
    ...
    lv_label_set_text(title_label, "室内温度");
